...
const nl: Translations = {
  ...
  guide: {
    ...
    step0Body: 'Een korte rondleiding langs de vijf belangrijkste onderdelen van de tool. Duurt minder dan een minuut.',
    step1Title: '1 · Vul uw situatie in',
    step1Body: 'Pas salaris, leeftijd, bijdragen en AOW aan in het invoerpaneel. Alle grafieken worden direct bijgewerkt.',
    step2Title: '2 · Drie scenario\'s',
    step2Body: 'De scenariokaarten tonen uw verwacht pensioeninkomen bij 2%, 5% en 8% jaarrendement. Zo ziet u de bandbreedte van uw uitkomst.',
    step3Title: '3 · Nominaal of reëel?',
    step3Body: 'Met de schakelaar "Toon reële waarden" in de balk bovenaan ziet u alle bedragen gecorrigeerd voor inflatie — wat uw pensioen werkelijk waard is in de koopkracht van vandaag.',
    step4Title: '4 · Fiscaal voordeel',
    step4Body: 'Pensioenpremies zijn aftrekbaar in box 1. De waterval laat zien hoeveel belastingvoordeel u in het eerste jaar realiseert.',
    step5Title: '5 · Woordenlijst',
    step5Body: 'Onderaan de pagina vindt u een uitgebreide woordenlijst met alle pensioenbegrippen zoals franchise, pensioengrondslag en jaarruimte uitgelegd.',
...
const en: Translations = {
  ...
  guide: {
    step0Title: 'Welcome to Pension Planner',
    step0Body: 'A quick tour of the five key parts of the tool. Takes less than a minute.',
    step1Title: '1 · Enter your details',
    step1Body: 'Adjust salary, age, contributions and state pension in the input panel. All charts update instantly.',
    step2Title: '2 · Three scenarios',
    step2Body: 'The scenario cards show your expected pension income at 2%, 5% and 8% annual return — the range of possible outcomes.',
    step3Title: '3 · Nominal or real?',
    step3Body: 'Toggle "Show real values" in the top bar to see all amounts adjusted for inflation — what your pension will actually be worth in today\'s purchasing power.',
    step4Title: '4 · Tax benefit',
    step4Body: 'Pension contributions are tax-deductible in box 1. The waterfall shows how much tax benefit you gain in the first year.',
    step5Title: '5 · Glossary',
    step5Body: 'At the bottom of the page you\'ll find a comprehensive glossary explaining all pension terms like franchise, pension base and annual space.',
    start: 'Start tour',
    prev: 'Previous',
    next: 'Next',
    skip: 'Skip',
